...
def make_animation(source_image, driving_video, generator, kp_detector, relative=True, adapt_movement_scale=True, cpu=False):
    ...
    with torch.no_grad():
        ...
        print(type(depth_source[0][0]))
        print(depth_source[0][0])
        print(depth_source[0][0].shape)
        ...
        for frame_idx in tqdm(range(driving.shape[2])):
            ...
            np.save(r"G:\0_0\image_folder\gray\relevant_data\ttm2\NEW_FOLDER6\KP/" +str(frame_idx)+  ".npy", kp_driving['value'].cpu())
...
if __name__ == "__main__":
    ...
    loaded_dict_enc = torch.load(r'F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN\checkpoints\depth_face_model\depth_face_model/encoder.pth')
    loaded_dict_dec = torch.load(r'F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN\checkpoints\depth_face_model\depth_face_model/depth.pth')
    ...
    subprocess.call(['K:/ENVIROMENT/newEnv/python.exe', 'C:/Users/Games/PycharmProjects/masToimage/extractFrames.py'])