...
#    json_path = r'F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN/celebvhq_info.json'  # json file path
#    raw_vid_root = r'F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN\celebV\raw/downloaded_celebvhq/raw/'  # download raw video path
#    processed_vid_root = r'F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN\celebV\processed/downloaded_celebvhq/processed/'  # processed video path
...
import json
with open(r"F:\PRESERVE_SPACE_PROJECTS\CVPR2022-DaGAN/celebvhq_info.json") as f:
    data_dict = json.load(f)
for key, val in data_dict['clips'].items():
    save_name = key+".mp4"
    ytb_id = val['ytb_id']
